...
export default function NavBar() {
    ...
    return <div>
        ...
        <nav className="lg:flex space-x-6 hidden   items-center">
            ...
            <div className="xl:w-[492px] lg:w-[290px] flex items-center  xl:ml-5">
                <div className="flex-1 mr-8 relative">
                    ...
                    <IoMdClose className="w-6 h-6 absolute text-black top-[6px] right-3 cursor-pointer" />

                    <input className="rounded-full bg-white focus:outline-none pr-4 pl-[3rem] py-2 text-black text-sm w-full  " placeholder="Search for WWE..." />
                </div>
        ...
        <nav className="lg:hidden block">
            ...
            <div
                className={`md:w-[40%] w-full  h-screen fixed top-0 left-0 z-[30] bg-black p-10 ${!navOpen ? "translate-x-[-100%]" : "translate-x-[0%]"
            ...
            >
                ...
                <ul className="mt-20">
                    {navItems.map((nav, index) => (
                        ...
                        >
                            <a
                                className="no-underline text-white cursor-pointer hover:text-[#fc1c4d] transition-all duration-150 ease-linear"
                                href={"#" + nav}
                            >
                                {nav}
                            </a>
